...
//                .requiresChannel(rcc -> rcc.anyRequest().requiresInsecure()) // HTTP
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/user", "/secure", "/reservations/api/all", "reservations/api/user", "prices/api/add", "/prices/api/delete/{priceId}","/prices/api/update/{id}", "/tickets/api/check-qr").authenticated()
